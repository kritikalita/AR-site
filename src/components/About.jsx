...
const NumberCounter = ({ value, suffix = "" }) => {
  ...
  return (
    ...
    <span ref={ref} className="block text-3xl md:text-5xl font-bold text-gradient">
      0{suffix}
    </span>
  );
};
...
const About = () => {
  return (
    <div id="about" className="scroll-mt-32 bg-transparent text-white py-16 md:py-24 px-6 md:px-12 lg:px-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          {/* ✅ UPDATED: text-gradient */}
          <h2 className="text-gradient font-bold tracking-widest uppercase mb-4 text-xs md:text-sm">
            About Us
          </h2>
