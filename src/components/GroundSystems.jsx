...
import { groundProducts } from "../data";
...
const GroundSystems = () => {
  ...
  return (
    <div id="ground" className="py-10 md:py-20 bg-transparent text-white border-t border-gray-800 px-6 md:px-12 lg:px-20 relative">
      <AnimatePresence>
        {selectedProduct && (
          <ProductModal 
      ...
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          className="mb-8 md:mb-12 border-l-4 border-[#73b2f8] pl-4 md:pl-6"
        >
                ...
                >
                  <TiltCard className="relative h-[420px] w-full flex flex-col rounded-xl bg-black border border-gray-700 overflow-hidden group">
                    ...
                    <span 
                      ...
                      className="absolute top-6 right-6 text-5xl font-bold text-white/50 z-30 group-hover:text-[#73b2f8] transition-colors duration-300"
                    >
                      0{item.id}
                    </span>
                    ...
                    >
                      ...
                      {/* ✅ UPDATED: text-[#73b2f8] */}
                      <div className="mt-auto text-center text-xs text-[#73b2f8]/70 uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity pt-4 pb-2">
                         Click for details
                      </div>
