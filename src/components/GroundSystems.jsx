    ...
    <div id="ground" className="py-10 md:py-20 bg-transparent text-white border-t border-gray-800 px-6 md:px-12 lg:px-20 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="mb-8 md:mb-12 border-l-4 border-cyan-500 pl-4 md:pl-6"
        >
          {/* ✅ UPDATED: Responsive font size scaling */}
        ...
        >
          <Swiper
            ...
            slidesPerView={1}
            // ✅ CONFIRMED: Perfect breakpoints for tablet (2 slides) and desktop (3 slides)
            breakpoints={{
